...
export default function VariantC() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="px-4 py-3 space-y-1">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="block px-3 py-2 text-base font-medium text-slate-600 hover:text-teal-600 hover:bg-orange-50 rounded-md"
              ...
              <a
                href="#contact"
                className="block px-3 py-2 mt-2 text-center bg-orange-500 text-white rounded-md font-semibold"
                onClick={() => setMenuOpen(false)}
              >
                Book Now
              </a>
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 to-orange-500 text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Join 10,000+ patients who love their smile
              </h1>
              <p className="text-lg md:text-xl text-teal-50 max-w-lg">
                Experience gentle, expert dentistry in a bright, comfortable office. Same-day appointments are available for busy families.
              </p>
              <div className="flex flex-wrap gap-4">
                <a
                  href="#contact"
                  className="px-7 py-3.5 bg-orange-500 text-white font-semibold rounded-full hover:bg-orange-600 transition shadow-lg"
                >
                  Book Appointment
                </a>
                <a
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-100 text-orange-700 text-sm font-semibold">
                ...
                Limited same-day appointments available this week
              </div>
              <div className="flex items-center gap-6 pt-2 text-sm text-teal-100">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-orange-400/20 rounded-3xl blur-3xl" />
              <img
      ...
      {/* Reviews — immediately after hero */}
              ...
              return (
                <div
                  ...
                  className={`relative p-8 rounded-2xl border ${
                    featured
                      ? 'md:col-span-3 bg-gradient-to-br from-orange-50 to-white border-orange-200 shadow-lg'
                      : 'bg-slate-50 border-slate-100 shadow-sm'
                  }`}
                >
                  {featured && (
                    <span className="absolute -top-3 left-6 px-3 py-1 bg-orange-500 text-white text-xs font-bold uppercase tracking-wide rounded-full">
                      Featured story
                    </span>
                  )}
                  ...
                  <p className={`text-slate-700 italic mb-6 ${featured ? 'text-xl md:text-2xl' : 'text-lg'}`}>
                    “{review.text}”
                  </p>
      ...
      {/* Services */}
      <section id="services" className="py-20 md:py-28 bg-orange-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              <div
                key={service.title}
                className="p-8 rounded-2xl border border-slate-100 bg-white hover:shadow-lg transition"
              >
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`relative flex flex-col rounded-2xl p-8 border ${
                  plan.featured
                    ? 'border-orange-500 bg-orange-50 shadow-xl ring-2 ring-orange-500'
                    : 'border-slate-200 bg-white shadow-md'
                }`}
              >
                {plan.featured && (
                  <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-orange-500 text-white text-xs font-bold uppercase tracking-wide rounded-full">
                    Most Popular
                  </span>
                )}
      ...
      {/* Office snapshots */}
      <section id="office" className="py-20 md:py-28 bg-orange-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            subtitle="Our Office"
      ...
      {/* Contact / CTA */}
      <section id="contact" className="py-20 md:py-28 bg-gradient-to-br from-teal-700 to-orange-500 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
            ...
            <form className="bg-white rounded-2xl p-8 text-slate-800 shadow-2xl" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
                <select className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-500">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-full transition"
                >
                  Request Appointment
                </button>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#plans" className="hover:text-orange-400 transition">Treatment Plans</a></li>
